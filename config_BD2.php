...
class db{
	...
	public function getAllEmployee(){
		...
		$query="SELECT players.playerID, players.playerName, team.team, gamestat.gamedate, playerstat.gameID, playerstat.point, playerstat.rb, playerstat.assist, playerstat.blk, playerstat.steal, playerstat.turnover FROM team
